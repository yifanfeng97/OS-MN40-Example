...
## Online Evaluation
You can submit the cdist.txt file with your team key on the track [website](https://shrec22.moon-lab.tech/). The submission with invalid team key will not appear on the leaderboard except for "Test Team". The online evaluation will use mAP, NN, NDCG@100, and ANMRR. The computation details of those scores can be found in "utils.py". The defination of those scores refer to the book [View-Based 3-d Object Retrieval](https://www.sciencedirect.com/topics/computer-science/criterion-measure).
